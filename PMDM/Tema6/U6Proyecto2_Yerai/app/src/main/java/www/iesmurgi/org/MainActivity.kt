...
fun VersionesAndroid()
{
    ...
    val versionAndroid= listOf("Android 10","Android 11","Android 12")
    val subVersions = mapOf(
        "Android 10" to listOf("10.0", "10.1"),
        "Android 11" to listOf("11.0", "11.1"),
        "Android 12" to listOf("12.0", "12.1", "12L"),
        "Android 13" to listOf("13.0", "13.1"))
    ...
    Column(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.Top, horizontalAlignment = Alignment.End)
    {
        ...
        if (selectedVersion != null) {
            Text("Versión seleccionada: $selectedVersion", style = MaterialTheme.typography.bodyLarge)
